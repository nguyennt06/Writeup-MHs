...
&rarr; Chuyển cửa sổ hiện tại của victim sang subdomain chứa script, ngay khi được kích hoạt, nó sẽ mượn danh nghĩa của subdomain để bypass CORS lấy dữ liệu, rồi tuồn về exploit server
